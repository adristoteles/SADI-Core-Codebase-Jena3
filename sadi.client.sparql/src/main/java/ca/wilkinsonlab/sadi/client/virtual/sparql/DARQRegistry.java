...
import org.sadiframework.client.RegistryBase;
import org.sadiframework.client.RegistrySearchCriteria;
import org.sadiframework.client.Service;
import org.sadiframework.client.ServiceInputPair;
import org.sadiframework.client.ServiceStatus;
...
public class DARQRegistry extends RegistryBase implements SPARQLRegistry 
{
	...
	{
		Node s = NodeFactoryExtra.parseNode("?s");
		Node p = NodeFactoryExtra.parseNode("?p");
		Node o = NodeFactoryExtra.parseNode(String.format("<%s>", uri));
	...
	{
		Node s = NodeFactoryExtra.parseNode(String.format("<%s>", uri));
		Node p = NodeFactoryExtra.parseNode("?p");
		Node o = NodeFactoryExtra.parseNode("?o");
